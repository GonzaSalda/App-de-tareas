...
const TodoItem = ({ item,deleteTodo,completeTodo }) => {
    return (
        <>
            ...
            <div className='flex justify-between items-center bg-white rounded-md my-2 px-2  border-2 border-gray-200 overflow-hidden'>
                ...
                <p className={`text-gray-400 px-2 text-2xl mb-2 ${item.completed && "line-through"} `}>{item.text}</p>
